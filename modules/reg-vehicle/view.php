<div class="content">
  <div class="row">
	...
	<div class="col-md-6" align="right" >
		<div class="input-group ">
			<input type="button" class="btn btn-success btn-add" value="ลงทะเบียนรถบรรทุก">
		</div>
	</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title"><i class="glyphicon glyphicon-list"></i>ลงทะเบียนรถบรรทุก </h5>
      </div>
      <div class="modal-body">
        ...
        <form role="form" id="frmUsers">
		  ...
		  <div class="col-lg-12 padding_2">
            <label for="zks" class="required-field">โซน / เขต / สาย : <span style='color:red'> * </span></label>
			<select class="select2 form-control" id="xid" name="fsmcode[]">
				<option></option>
			</select>
          </div>
          <div class="col-lg-12 padding_2">
            <label for="vehicle_name" class="required-field">ทะเบียนรถ : <span style='color:red'> * </span></label>
            <input type="text" placeholder="ทะเบียนรถ"  class="form-control" name="vehicle_name">
          </div>
          <div class="col-lg-12 padding_2">
            <label for="vehicle_type" class="required-field">ประเภทรถ:</label>
            <select class="select2 form-control" id="vehicle_type" name="vehicle_type"></select>
          </div>
