      ...
      <form action="#" method="post" id="frmFind" class="form-inline " style="padding-bottom: 5px;">
        ...
        <div class="form-group button-form-group">
          <div class="input-group">
            <input type="text" placeholder="วันที่ลงทะเบียน" class="form-control  date" name="daterange" value="" style="width:200px;" />
          </div>
        </div>

<div class="input-group ">
    <button type="button" class="btn btn-info btn-rpcard">พิมพ์รายงาน </button>
</div>
        <div class="input-group ">
<style>
...
table.dataTable tbody tr.selected {
    background-color: #B0BED9;
          ...
          <button type="button" class="btn btn-primary btn-print">พิมพ์บัตร  <span class="badge badge-success">0</span></button>
          <!--<input type="button" class="btn btn-success btn-add" value="พิมพ์บัตรทะเบียนชาวไร่ ">-->
        </div>
        <div class="input-group ">
            <button type="button" class="btn btn-warning " onClick="window.location.reload();"> ยกเลิก  </button>
        </div>
