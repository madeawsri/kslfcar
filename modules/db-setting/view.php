  ...
  <div class="row">
    ...
    <div class="col-md-12" align="right">
      ...
      <form action="#" method="post" id="frmFind" class="form-inline " style="padding-bottom: 5px;">
        <div class="input-group "><input type="button" class=" hide btn btn-success btn-add" value="ตั้งค่าฐานข้อมูล Softpro">
        </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title"><i class="glyphicon glyphicon-list"></i>ตั้งค่าเชื่อมต่อฐานข้อมูล Softpro </h5>
      </div>
...
-->
        ...
        <form role="form" id="frmUsers">
          ...
          <div class="col-lg-12 padding_2">
            <label for="user_name" class="required-field">ชื่อโฮสต์เนม : <span style='color:red'> * </span></label>
            <input type="text" placeholder="" class="form-control" name="host_name">
          </div>
          <div class="col-lg-6 padding_2">
            <label for="user_name" class="required-field">ผู้ใช้ : <span style='color:red'> * </span></label>
            <input type="text" placeholder="" class="form-control" name="user_name">
          </div>
          <div class="col-lg-6 padding_2">
            <label for="user_login" class="required-field">รหัสผ่าน : <span style='color:red'> * </span></label>
            <input type="text" placeholder=""  class="form-control" name="pass_name">
          </div>
          <div class="col-lg-6 padding_2">
            <label for="user_password" class="required-field label_user_password">ชื่อฐานข้อมูล : <span style='color:red'> * </span></label>
            <input type="text" placeholder="" class="form-control" name="db_name">
          </div>
