...
<div class="modal fade" id="mModal" role="dialog">
  ...
  คิวรถร่วม
          ...
          <input type="radio" class="option-input radio" id="rType2" name="rType" value="3" />
          คิวรถศูนย์
          </label>
      ...
      <div class="modal-body">
        ...
        <form role="form" id="frm" style='font-size:18px'>
          ...
          <div class="col-lg-12 padding_2 paid_type2" style='display:none;'>
          <label for="truck_type" class="required-field">ศูนย์ขนถ่าย <span style='color:red'> * </span></label>
             <select class="select2 form-control" id="center_no" name="center_no"></select>
          </div>
