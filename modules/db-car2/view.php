  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title"><i class="glyphicon glyphicon-list"></i>ลงทะเบียนรถชาวไร่ </h5>
      </div>
      <div class="modal-body">
        ...
        <form role="form" id="frmUsers">
          ...
          <div class="col-lg-4 padding_2">
            <label for="select_zks" class="required-field">โซน / เขต / สาย : <span style='color:red'> * </span></label>
            <select class="select2 form-control" id="select_zks" name="zks">
              {regcartype_option}
            </select>
          </div>
          <div class="col-lg-4 padding_2">
          <label for="temp" class="required-field"> </label>
            <input type="text"   style="background:rgba(0,0,0,0);" class="text-label form-control" name="temp2" id="temp" disabled>
          </div>
          <div class="col-lg-4 padding_2">
          <label for="temp" class="required-field"></label>
            <input type="text"   style="background:rgba(0,0,0,0);" class="text-label form-control" name="temp3" id="temp" disabled>
          </div>

          <div class="col-lg-4 padding_2">
            <label for="user_name" class="required-field">ทะเบียนรถ : <span style='color:red'> * </span></label>
            <input type="text" placeholder=""  class="form-control" name="car_no">
          </div>
          
          <div class="col-lg-4 padding_2">
            <label for="user_level" class="required-field">ประเภทรถ :</label>
            <select class="select2 form-control" id="user_level" name="car_type">
              {regcartype_option}
            </select>
          </div> 

          <div class="col-lg-4 padding_2">
            <label for="user_level" class="required-field">จำนวนสูงสุดส่งอ้อย :</label>
            <input type="number" placeholder="" style="text-align:right;" maxlength='5'  class="form-control" name="car_send" value='0'>
          </div> 

          <div class="col-lg-12 padding_2">
            <label for="user_level" class="required-field">โควต้า-ชื่อชาวไร่: <span style='color:red'> * </span></label>
            <input type="text" placeholder=""   class="form-control" name="fcucode" value='0'>
          </div> 

          <!--<div class="col-lg-8 padding_2">
            <label for="user_level" class="required-field">ชื่อชาวไร่ :</label>
            <input type="text" placeholder="" style="background:rgba(0,0,0,0);" class=" text-label form-control" name="car_send" value=' xxxx ' disabled>
          </div> -->
