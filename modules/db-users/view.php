          ...
          <table style="width:100%" id="customer-table" class="dataTable table table-bordered table-condensed table-hover">
            <thead>
              <tr class="">
                ...
                <!-- <th>สิทธ์ในการเข้าใช้งาน<th>
                <th>เข้าใจงานล่าสุด</th> -->
              </tr>
            </thead>
          </table>
      ...
      <div class="modal-body">
        ...
        <form role="form" id="frmUsers">
          ...
          <div class="col-lg-7 padding_2">
            <label for="user_name" class="required-field">ชื่อ-สกุล : <span style='color:red'> * </span></label>
            <input type="text" placeholder="ชื่อ-สกุล"  class="form-control" name="user_name">
          </div>
          ...
          <div class="col-lg-6 padding_2">
            <label for="user_login" class="required-field">ชื่อเข้าระบบ : <span style='color:red'> * </span></label>
            <input type="text" placeholder="ชื่อเข้าระบบ" maxlength='3'  class="form-control" name="user_login">
          </div>
          <div class="col-lg-6 padding_2">
            <label for="user_password" class="required-field label_user_password">รหัสผ่าน : <span style='color:red'> * </span></label>
            <input type="text" placeholder="รหัสผ่าน"  class="form-control" name="user_password">
          </div>
