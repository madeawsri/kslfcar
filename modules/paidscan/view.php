  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title"><i class="glyphicon glyphicon-list"></i>แจ้งคิว (สแกนบัตรรถชาวไร่)
  ...
  คิวรถร่วม
      ...
      <div class="modal-body">
        ...
        <form role="form" id="frm" style='font-size:18px'>
          ...
          <div class="col-lg-4 padding_2 paid_type0 div_barcode">
          ...
          <div class="col-lg-4 padding_2 paid_type0 hide">
            <label for="temp" class="required-field">รหัสบัตรรถชาวไร่ <span style='color:red'> * </span> </label>
          ...
          <div class="col-lg-7 padding_2 paid_type0 div_qoata">
          ...
          <div class="col-lg-5 padding_2 paid_type0 hide">
          ...
          <div class="col-lg-7 padding_2 div_canetype ">
